...
var G__26872 = o;
(G__26872[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26876 = o;
(G__26876[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26877__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__26877 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__26878__i < G__26878__a.length) {G__26878__a[G__26878__i] = arguments[G__26878__i + 0]; ++G__26878__i;}
  args = new cljs.core.IndexedSeq(G__26878__a,0,null);
} 
return G__26877__delegate.call(this,args);};
G__26877.cljs$lang$maxFixedArity = 0;
G__26877.cljs$lang$applyTo = (function (arglist__26879){
var args = cljs.core.seq(arglist__26879);
return G__26877__delegate(args);
});
...
var G__26881 = props;
var G__26881__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26881,cljs.core.cst$kw$id,id):G__26881);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26881__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26882){
...
var props = map__26883__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26883__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26883,map__26883__$1,props,class$){
return (function (c){
...
});})(map__26883,map__26883__$1,props,class$))
,class$)));
} else {
return props;
}
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26886__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26886,map__26886__$1,on_write){
return (function (){
...
});})(node_value,map__26886,map__26886__$1,on_write))
);
} else {
...
var G__26889 = jsprops;
(G__26889["defaultValue"] = value);

(G__26889["onChange"] = ((function (G__26889,v,value,on_change){
return (function (p1__26888_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26888_SHARP_);
});})(G__26889,v,value,on_change))
);
...
var vec__26892 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26892,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26892,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26892,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26896 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26896 == null)){
} else {
var key_26897 = temp__5724__auto___26896;
(jsprops["key"] = key_26897);
}
...
var temp__5724__auto___26898 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26898 == null)){
} else {
var key_26899 = temp__5724__auto___26898;
reagent.impl.template.oset(jsprops,"key",key_26899);
}
...
var G__26900 = reagent.impl.template.__GT_NativeWrapper();
(G__26900["name"] = c);
...
var G__26901 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26901) : reagent.impl.template.as_element.call(null,G__26901));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26905){
var G__26906 = cljs.core.first(seq26905);
var seq26905__$1 = cljs.core.next(seq26905);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26906,seq26905__$1);
});
...
break;
default:
var G__26912 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26912;
continue;
...
var n__4607__auto___26914 = a.length;
var i_26915 = (0);
while(true){
if((i_26915 < n__4607__auto___26914)){
(a[i_26915] = reagent.impl.template.as_element((a[i_26915])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26917 = a.length;
var i_26918 = (0);
while(true){
if((i_26918 < n__4607__auto___26917)){
var val_26919 = (a[i_26918]);
if(((cljs.core.vector_QMARK_(val_26919)) && ((reagent.impl.template.key_from_vec(val_26919) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26918] = reagent.impl.template.as_element(val_26919));
...
var ctx = ({});
var vec__26921 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
...
var G__26927 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26925,G__26926,G__26927) : reagent.impl.template.global$module$react.createElement.call(null,G__26925,G__26926,G__26927));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26924){
