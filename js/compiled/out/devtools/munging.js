...
var o22380 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22380["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22381 = temp__5718__auto____$1;
return (o22381["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21492__auto__ = f;
return (o__21492__auto__["toString"]).call(o__21492__auto__);
} else {
return "";
}
}catch (e22382){var _ = e22382;
return "";
}});
...
try{var o__21492__auto___22384 = t;
(o__21492__auto___22384["cljs$lang$ctorPrWriter"]).call(o__21492__auto___22384,t,writer);
}catch (e22383){var __22385 = e22383;
}
...
var char_code = (function (){var o__21492__auto__ = (new String(char$));
return (o__21492__auto__["charCodeAt"]).call(o__21492__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21492__auto__ = String;
return (o__21492__auto__["fromCharCode"]).call(o__21492__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22386 = num_code;
switch (G__22386) {
case (1):
return (185);
...
var o__21492__auto__ = String;
return (o__21492__auto__["fromCharCode"]).call(o__21492__auto__,superscript_code);
});
/**
...
}catch (e22388){var _e__21499__auto__ = e22388;
return false;
}})())){
...
var vec__22389 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22389,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22392 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22392["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22393 = temp__5718__auto____$1;
return (o22393["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22396){
var vec__22397 = p__22396;
var ns_detector = cljs.core.nth.call(null,vec__22397,(0),null);
...
var G__22403 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22404 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22403;
remaining_tokens = G__22404;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22394){
var G__22395 = cljs.core.first.call(null,seq22394);
var seq22394__$1 = cljs.core.next.call(null,seq22394);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22395,seq22394__$1);
});
...
var vec__22408 = cljs.core.split_with.call(null,(function (p1__22407_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22407_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22408,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22408,(1),null);
...
var vec__22414 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22414,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22414,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22417 = cljs.core.rest.call(null,remaining_tokens);
var G__22418 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22417;
name_tokens = G__22418;
continue;
} else {
...
var vec__22421 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22421,(0),null);
var arity = cljs.core.nth.call(null,vec__22421,(1),null);
var vec__22424 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22424,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22424,(1),null);
var vec__22427 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22427,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22427,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22427,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22427,(3),null);
...
var vec__22433 = result;
var munged_ns = cljs.core.nth.call(null,vec__22433,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22433,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22433,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22433,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22433,(4),null);
var arity = cljs.core.nth.call(null,vec__22433,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22437 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22437,(0),null);
var args = cljs.core.nth.call(null,vec__22437,(1),null);
var vec__22440 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22440,(0),null);
var name = cljs.core.nth.call(null,vec__22440,(1),null);
...
var G__22443 = (arity + (1));
var G__22444 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22445){
var vec__22446 = p__22445;
var arity = cljs.core.nth.call(null,vec__22446,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22446,(1),null);
...
return cljs.core.get.call(null,arities,p1__22449_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22450_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22453){
var vec__22454 = p__22453;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22454,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22451){
var G__22452 = cljs.core.first.call(null,seq22451);
var seq22451__$1 = cljs.core.next.call(null,seq22451);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22452,seq22451__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22462__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22462__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22462__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22462__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22463 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22463,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22463,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22463,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22463,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22463,(4),null);
var arity = cljs.core.nth.call(null,vec__22463,(5),null);
...
var o__21492__auto__ = f;
return (o__21492__auto__["getBasis"]).call(o__21492__auto__);
});
/**
...
}catch (e22467){var _e__21499__auto__ = e22467;
...
var G__22468 = (obj[cljs.core.first.call(null,path)]);
var G__22469 = cljs.core.rest.call(null,path);
obj = G__22468;
path = G__22469;
continue;
} else {
...
return (function (accum,p__22470){
var vec__22471 = p__22470;
var bit = cljs.core.nth.call(null,vec__22471,(0),null);
var protocol = cljs.core.nth.call(null,vec__22471,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22474){
var vec__22475 = p__22474;
var ns = cljs.core.nth.call(null,vec__22475,(0),null);
var name = cljs.core.nth.call(null,vec__22475,(1),null);
var selector = cljs.core.nth.call(null,vec__22475,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22480,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22480,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22480,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22478_SHARP_){
return (obj[cljs.core.first.call(null,p1__22478_SHARP_)]);
});})(name,sorted_matches,vec__22480,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1586980122497
